...
function Navbar() {
  return (
    <>
      <nav className="bg-white border-gray-200bg-gradient-to-b from-gray-50 to-gray-200 dark:from-gray-900 dark:to-gray-800 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 shadow-lg">
